...
class FeedbackServiceImplTest {
  ...
  void should_create_feedback_successfully_for_completed_appointment() {
    ...
    assertThat(coach.getRatingAvg())
        .isEqualTo(26.0 / 6.0, org.assertj.core.data.Offset.offset(0.001));
  }
  ...
  void should_get_feedbacks_by_coach_id_successfully() {
    ...
    FeedbackResponse expectedResponse =
        FeedbackResponse.builder().id(1).rating(5).content("Great service!").build();
  ...
  void should_get_feedbacks_for_coach_account_successfully() {
    ...
    Page<FeedbackResponse> result =
        feedbackService.getFeedbacksForCoachAccount(accountId, pageable);
