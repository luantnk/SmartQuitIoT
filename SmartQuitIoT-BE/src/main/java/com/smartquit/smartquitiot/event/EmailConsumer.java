...
public class EmailConsumer {
  ...
  public void handleEmailEvent(EmailMessageDTO message) {
    log.info(
        "Received email event. Template: [{}], To: [{}]",
      ...
      switch (message.getTemplateName()) {
        ...
        case "payment-success":
          ...
          emailService.sendPaymentSuccessEmail(
              message.getTo(), successName, successPackage, amount, successOrderCode);
          break;
        ...
        case "payment-cancel":
          ...
          emailService.sendPaymentCancelEmail(
              message.getTo(), cancelName, cancelPackage, cancelOrderCode);
          break;
