...
public class MembershipSubscriptionMapper {
  ...
  public MembershipSubscriptionDTO toMembershipSubscriptionDTO(
    ...
    membershipSubscriptionDTO.setMembershipPackage(
        membershipPackageMapper.toMembershipPackageDTO(
    ...
    membershipSubscriptionDTO.setMember(
        memberMapper.toMemberDTO(membershipSubscription.getMember()));

    return membershipSubscriptionDTO;
  }

  public MembershipSubscriptionDTO toMembershipSubscriptionPayment(
      MembershipSubscription membershipSubscription) {
    if (membershipSubscription == null) return null;
