...
public class ChatbotTools {
  ...
  @Tool(
      name = "getQuitPlanByMemberId",
      description = "Retrieve the quit plan information by member ID.")
  public QuitPlanToolResponse getQuitPlanByMemberId(
      @ToolParam(description = "The unique identifier of the member") Integer memberId) {
  ...
  @Tool(
      name = "getLatestDiaryRecordByMemberId",
  ...
  public DiaryRecordDTO getLatestDiaryRecordByMemberId(
    ...
    Optional<DiaryRecord> previousDayRecord =
        diaryRecordRepository.findTopByMemberIdOrderByDateDesc(memberId);
    return previousDayRecord.map(diaryRecordMapper::toDiaryRecordDTO).orElse(null);
  }

  @Tool(
      name = "getHealthRecoveriesByMemberId",
  ...
  @Tool(
      name = "getMissionsInCurrentPhaseByMemberId",
      description =
          "Get ALL missions in the member's current phase (past, today, and future), grouped by"
              + " phase detail date. Includes currentDate for comparison.")
  public MissionsInPhaseWrapperResponse getMissionsInCurrentPhaseByMemberId(
      @ToolParam(description = "The unique identifier of the member") Integer memberId) {
    log.info("hello ae");
    try {
