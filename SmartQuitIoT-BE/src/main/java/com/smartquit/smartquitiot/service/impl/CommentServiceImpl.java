    ...
    if (request.getParentId() != null) {
      parent =
          commentRepository
              ...
              .orElseThrow(
                  () -> new RuntimeException("Parent comment not found: " + request.getParentId()));
      ...
      if (acc.getRole() == Role.MEMBER) {
        Member mem =
            memberRepository
                ...
                .orElseThrow(
                    () -> new RuntimeException("Member not found with account id: " + acc.getId()));
        ...
        Coach coach =
            coachRepository
                .findByAccountId(acc.getId())
                .orElseThrow(
                    () -> new RuntimeException("Coach not found with account id: " + acc.getId()));
