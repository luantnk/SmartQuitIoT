...
public interface PhaseService {
  PhaseResponse generatePhasesInFirstLogin(
  ...
  PhaseResponse generatePhases(
      int smokeAvgPerDay, int numberOfYearsSmoking, LocalDate startDate, int FTND, Account account);
