...
public class AchievementServiceImpl implements AchievementService {
  ...
  public Page<AchievementDTO> getAllAchievements(int page, int size, String search) {
    ...
    Specification<Achievement> spec =
        Specification.allOf(
  ...
  public AchievementDTO createAchievement(CreateAchievementRequest request) {
    ...
    notificationService.sendSystemActivityNotification(
        "New achievement created: " + request.getName(),
        "A new achievement has been added to the system. Check it out!");
  ...
  private void validateCondition(JsonNode condition) {
    ...
    List<String> validFields =
        Arrays.asList(
            ...
            "post_count",
            "comment_count",
            "total_mission_completed",
            "completed_all_mission_in_day");
