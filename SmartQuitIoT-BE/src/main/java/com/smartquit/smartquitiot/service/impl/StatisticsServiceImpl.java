...
public class StatisticsServiceImpl implements StatisticsService {
  ...
  public DashboardStatisticsDTO getDashboardStatistics() {
    ...
    long completedThisWeek =
        appointmentRepository.countCompletedBetweenByCoachId(coachId, startOfWeek, endOfWeek);
    long completedLastWeek =
        appointmentRepository.countCompletedBetweenByCoachId(
            coachId, startOfLastWeek, endOfLastWeek);
    ...
    long newMembersThisMonth =
        memberRepository.countNewMembersByCoachIdSince(coachId, startOfMonth);
