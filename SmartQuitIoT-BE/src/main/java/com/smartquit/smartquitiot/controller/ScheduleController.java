...
public class ScheduleController {
  ...
  @Operation(summary = "Assign coaches to work dates")
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<GlobalResponse> assignCoachesToDates(
  ...
  public ResponseEntity<GlobalResponse> updateScheduleByDate(
      @PathVariable LocalDate date, @Valid @RequestBody ScheduleUpdateRequest request) {
  ...
  /**
   * Coach: get own workdays (no need to send accountId from FE) Example: GET
   * /schedules/me/workdays?year=2025&month=11
   */
