...
public class CommentController {
  ...
  @Operation(
      summary = "Create comment or reply on post",
      description = "Comment a post or reply to a comment")
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<GlobalResponse<PostDetailDTO.CommentDTO>> createComment(
      @PathVariable("postId") Integer postId, @RequestBody CommentCreateRequest request) {
  ...
  @Operation(
      ...
      description = "Retrieve all root comments and replies of a post")
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<GlobalResponse<java.util.List<PostDetailDTO.CommentDTO>>>
      getCommentsByPostId(@PathVariable("postId") Integer postId) {
  ...
  public ResponseEntity<GlobalResponse<PostDetailDTO.CommentDTO>> updateComment(
      @PathVariable("commentId") Integer commentId, @RequestBody CommentUpdateRequest request) {
