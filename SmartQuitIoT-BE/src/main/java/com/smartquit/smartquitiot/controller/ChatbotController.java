...
public class ChatbotController {
  ...
  public ResponseEntity<?> chatBot(@RequestBody ChatbotPayload chatbotPayload) {
    ...
    simpMessagingTemplate.convertAndSend(
        "/topic/chatbot/" + chatbotPayload.getMemberId(), aiResponse);
  ...
  public ResponseEntity<?> getChatbotMessagesByConversationId(
  ...
  public GlobalResponse<ChatbotResponse> chatVoice(
      @RequestPart("file") MultipartFile file, @RequestParam("memberId") String memberId) {
