...
public class SystemPhaseConditionController {
  ...
  public ResponseEntity<SystemPhaseConditionDTO> updateSystemPhaseCondition(
      @PathVariable Integer id, @RequestBody UpdateSystemPhaseConditionRequest request) {
    SystemPhaseConditionDTO response =
        systemPhaseConditionService.updateSystemPhaseCondition(id, request);
