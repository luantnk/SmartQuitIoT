...
public class MemberController {
  ...
  public ResponseEntity<Page<MemberDTO>> manageMembers(
    ...
    log.info(
        "ADMIN ACCESS: Managing members list. Page: {}, Search: '{}', IsActive: {}",
        page,
        search,
        isActive);
  ...
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<MemberDTO> updateReminderSettings(
      @RequestBody MemberReminderSettingsRequest req) {
