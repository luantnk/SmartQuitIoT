...
public class CoachController {
  ...
  @Operation(
      summary = "Get all coaches (admin,member)",
      description = "Returns full list of CoachSummaryDTO, no filtering/paging")
  @SecurityRequirement(name = "Bearer Authentication")
  ...
  @Operation(
      summary = "Get all coaches (admin)",
      description = "Returns full list of CoachDTO filtering/paging")
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<GlobalResponse<Page<CoachDTO>>> getAllCoaches(
    ...
    return ResponseEntity.ok(
        GlobalResponse.ok(coachService.getAllCoaches(page, size, searchString, sortBy, isActive)));
  }
  ...
  @PutMapping("/{coachId}")
  @Operation(
      summary = "This endpoint for update coach profile",
      description = "Admin and Coaches can update their own profile")
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<CoachDTO> updateCoachProfile(
      @PathVariable int coachId, @RequestBody CoachUpdateRequest request) {
