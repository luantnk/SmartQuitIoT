...
public class NewsController {
  ...
  public ResponseEntity<GlobalResponse<NewsDTO>> createNews(
      @RequestBody CreateNewsRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(GlobalResponse.ok(newsService.createNews(request)));
  }
  ...
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<GlobalResponse<NewsDTO>> updateNews(
      @PathVariable int id, @RequestBody CreateNewsRequest request) {
  ...
  @Operation(
      ...
      description = "Manually triggers a migration of all old News data into Elasticsearch index")
