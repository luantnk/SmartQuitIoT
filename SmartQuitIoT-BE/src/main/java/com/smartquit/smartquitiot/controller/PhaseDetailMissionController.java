...
public class PhaseDetailMissionController {
  ...
  public ResponseEntity<QuitPlanResponse> completePhaseDetailMission(
      @RequestBody CompleteMissionRequest req) {
    log.info(
        "REST request to complete mission from Detail View. MissionID: {}",
        req.getPhaseDetailMissionId());
  ...
  public ResponseEntity<MissionTodayResponse> completePhaseDetailMissionAtHomePage(
      @RequestBody CompleteMissionRequest req) {
    log.info(
        "REST request to complete mission from Home Page. MissionID: {}",
        req.getPhaseDetailMissionId());
    MissionTodayResponse response =
        phaseDetailMissionService.completePhaseDetailMissionAtHomePage(req);
  ...
  public ResponseEntity<?> getListMissionTodayByMemberId(@PathVariable int memberId) {
    ...
    return ResponseEntity.ok(
        phaseDetailMissionService.getAllMissionsInCurrentPhaseByMemberId(memberId));
  }
}
