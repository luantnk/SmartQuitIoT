...
public class MetricController {
  ...
  @Operation(
      summary = "Get metric statistic for the authenticated member",
  ...
  @SecurityRequirement(name = "Bearer Authentication")
  @Operation(
      summary = "Get health recovery statistic for the authenticated member",
      description =
          "API để hiển các thông số Pulse Rate, Oxygen Level, Carbon Monoxide Level của member trên"
              + " home screen")
  ...
  @SecurityRequirement(name = "Bearer Authentication")
  @Operation(
      summary = "Get health data statistic for the authenticated member",
  ...
  @Operation(
      summary = "Get health data statistic for member",
      description = "API để lấy dữ liệu sức khỏe của member")
