...
public class QuitPlanController {
  ...
  public ResponseEntity<PhaseBatchMissionsResponse> createQuitPlanInFirstLogin(
      @RequestBody CreateQuitPlanInFirstLoginRequest req) {
  ...
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<QuitPlanResponse> keepPhaseOfQuitPlan(
      @RequestBody KeepPhaseOfQuitPlanRequest req) {
  ...
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<PhaseBatchMissionsResponse> createNew(
      @RequestBody CreateNewQuitPlanRequest req) {
