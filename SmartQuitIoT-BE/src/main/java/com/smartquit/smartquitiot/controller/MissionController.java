...
public class MissionController {
  ...
  @Operation(
      summary = "Get all mission",
      description = "Returns full list of missions filtering/paging")
  public ResponseEntity<Page<MissionDTO>> getAllMissions(
    ...
    log.debug(
        "ADMIN: Fetching missions page: {}, size: {}, search: '{}', phase: {}",
        page,
        size,
        search,
        phase);
  ...
  @Operation(
      ...
      description = "Create a new mission with validation for unique code")
  ...
  @Operation(
      ...
      description = "Update an existing mission with validation for unique code")
  public ResponseEntity<MissionDTO> updateMission(
      @PathVariable int id, @Valid @RequestBody UpdateMissionRequest request) {
