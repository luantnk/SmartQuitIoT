...
public class AchievementController {
  ...
  public ResponseEntity<Achievement> addMemberAchievements(
  ...
  @PreAuthorize("hasRole('ADMIN')")
  @SecurityRequirement(name = "Bearer Authentication")
  public ResponseEntity<AchievementDTO> createNewAchievement(
  ...
  public ResponseEntity<AchievementDTO> update(
      @PathVariable int id, @RequestBody CreateAchievementRequest request) {
